...
config_options=-file_move_module ReseqTrack::Hive::Process::FileRelease::Move::Blueprint::Move
...
sub default_options {
    ...
    return {
        ...
        file_move_module => 'ReseqTrack::Hive::Process::FileRelease::Move::Blueprint::Move',
        ...
        derive_path_options => { 
                                ...
                                run_meta_data_file => 'run_meta_data.tab',
                               },
        move_by_rsync => 0,
    };
}
