...
Options:
 ...
 -infile, tab-delimited file listing the ERA experiment id, new sample alias, must have headers

 e.g EXPERIMENT_ID <TAB> NEW_SAMPLE_ALIAS 
...
=head1 Examples
 ...
 perl exp_sample_swap_xml.pl -infile list_of_experiments_for_sample_swap -era_user $ERA_USER_NAME -era_pass $ERA_PASSWORD 
